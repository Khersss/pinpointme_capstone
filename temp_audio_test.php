...
$response = Illuminate\Support\Facades\Http::timeout(60)->acceptJson()->asJson()->post('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=' . urlencode($apiKey), $payload);
